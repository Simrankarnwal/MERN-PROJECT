      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row ">
        ...
        <div className="flex-1">
          ...
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1">
            ...
            <p>Cash On Delivery is available on thsi Product.</p>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p className="">
            ...
            products or services directly to customers via the internet. It acts
            as a digital storefront, enabling transactions, order management,
            and customer interactions, similar to a physical retail store but
